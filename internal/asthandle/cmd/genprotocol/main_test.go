...
func TestGenerateSchemaAndValidation(t *testing.T) {
	...
	for _, needle := range []string{"HANDLE_OPERATION_PARSE", "HANDLE_NODE_DECL", "HANDLE_PATCH_SETFIELD", "HANDLE_EVENT_ENTER", "HANDLE_STATUS_EXHAUSTED", "HANDLE_CAPABILITY_STRUCTUREDERRORS"} {
